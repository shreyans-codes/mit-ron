...
type Authenticator interface {
	...
	CreatePollMessage(chatID, senderID, question string, options []string, isMultipleChoice bool, parentID, threadID *string) (*models.Message, error)
	VotePoll(messageID, userID, optionID string) (*models.MessagePollDetails, error)
	AttachPollDetails(messages []models.Message, viewerUserID string) ([]models.Message, error)
	...
	GetChatMessagesPaginated(chatID string, limit int, beforeMessageID *string) ([]models.Message, error)
	...
	UpdateEvent(eventID, title, description string) (*models.Event, error)
}
