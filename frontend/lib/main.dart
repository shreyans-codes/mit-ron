          ...
          return MaterialApp(
            ...
            routes: {
              ...
              UserProfilePage.routeName: (context) { 
                ...
                return const UserProfilePage(username: ''); // Provide a default or handle error
              },
              FriendsListPage.routeName: (_) => const FriendsListPage(),
              GroupListPage.routeName: (_) => const GroupListPage(), // Add route for GroupListPage
              CreateGroupPage.routeName: (_) => const CreateGroupPage(), // Add route for CreateGroupPage
              JoinGroupPage.routeName: (_) => const JoinGroupPage(), // Add route for JoinGroupPage
            },
          );
        },
      ),
